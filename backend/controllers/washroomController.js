...
const createWashroom = asyncHandler(async (req, res) => {
  const { location, station_name, station_id, price, notes, status } = req.body;
...
const updateWashroom = asyncHandler(async (req, res) => {
  ...
  if (washroom) {
    ...
    washroom.price = price || washroom.price;
...
const createWashroomTicket = asyncHandler(async (req, res) => {
    const { washroom_id, time, served_by, payment_method, isPaid } = req.body;
...
const createAmenity = asyncHandler(async (req, res) => {
  const { washroom_id, name, status } = req.body;

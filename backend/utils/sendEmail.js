...
const sendTicketPurchaseEmail = async (userEmail, ticketDetails) => {
  try {
    const message = `
      Thank you for choosing to travel with 2M! Here are your ticket details:<br>
...
/**
 * @desc   Function to send trip start notification email
 */
const sendTripStartEmail = async (userEmail, tripDetails) => {
  try {
    const message = `
      Your trip has started! Here are the details:<br>
